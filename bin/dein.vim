" Infor: This file is resposible for setting up Dein Plugin Manager 
" Credit: @hardcoreplayers/ThinkVim
" Set custom augroup
...
let s:config_paths = get(g:, 'etc_config_paths', [
  ...
  \ $VIM_PATH . '/plugins/editing.yaml',
  \ $VIM_PATH . '/plugins/utils.yaml',
  \ $VIM_PATH . '/plugins/completion.yaml',
